...
Use ~major-mode-remap-alist~ to transparently activate tree-sitter variants
for built-in modes, and ~auto-mode-alist~ for languages whose base modes are
not built in to Emacs or require non-standard file extension associations.
