...
Completion settings, see
[[https://www.gnu.org/software/emacs/manual/html_node/emacs/Completion-Styles.html][Emacs
Docs - Completion Options]] for details.
  ...
  (use-package modus-themes
    ...
    (setq modus-themes-headings
          '((0 . (variable-pitch (height 2.2)))
            (1 . (variable-pitch (height 1.8)))
            (2 . (variable-pitch monochrome (height 1.4)))
            (3 . (variable-pitch monochrome (height 1.3)))
            (4 . (variable-pitch monochrome (height 1.2)))
            (5 . (variable-pitch monochrome (height 1.1)))
