...
#+BEGIN_SRC emacs-lisp
  ...
  (add-to-list 'exec-path "~/.yarn/bin")   ;; JS -- Yarn installed
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package org-caldav
    ...
    (setq org-caldav-url "https://caldav.fastmail.com/dav/calendars/user/me@rosstimson.com")
    (setq org-icalendar-timezone "Europe/London")
    ;; never delete anything at the CALDAV end
    (setq org-caldav-delete-calendar-entries 'never)

    ;; Default inbox, without this it still seems to want to create the
    ;; default of ~/org/appointments.org despite the settings below in
    ;; org-caldav-calendars.
    (setq org-caldav-inbox '(file+headline "~/org/cal.org" "Inbox"))
    (setq org-caldav-files '("~/org/cal.org"))

    (setq org-caldav-calendars
          '((:calendar-id "530726a6-d153-4195-b3dc-18f2985aea53"
                          :inbox (file+headline "~/org/cal.org" "Personal Inbox"))
            (:calendar-id "97fb7751-8aad-41ea-a48d-0b9199de9f20"
                          :inbox (file+headline "~/org/cal.org" "Work Inbox")))))
#+end_src
...
[[https://common-lisp.net/project/slime/][[[https://github.com/clojure-emacs/clojure-mode][Clojure Mode]] is a major mode for Clojure.
